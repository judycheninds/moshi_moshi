const translations = {
    "en": {
        ...
        "lang-ko": "Korean",
        "deposit-title": "Payment Method",
        "deposit-desc": "A credit card is required on file. A $5 service fee is charged ONLY when your reservation is successfully confirmed.",
        "label-cc-name": "Cardholder Name",
        "label-cc-number": "Card Number",
        "label-cc-exp": "Expiry (MM/YY)",
        "label-cc-cvc": "CVC",
        "btn-call": "Initiate AI Call",
        "btn-schedule": "📅 Schedule Call",
        "mode-now": "Call Now",
        "mode-schedule": "Schedule",
        "label-callMode": "When to Call",
        "label-scheduledAt": "Call Date & Time",
        "schedule-hint": "💡 AI will call the restaurant at exactly this time. Perfect for when they open!",
        ...
        "label-adults": "Adults",
        "label-kids": "Children",
        "label-kids-age": "Under 12 yrs",
        "alt-offer-desc": "The requested time wasn't available. The restaurant proposed:",
        "deposit-charged-title": "✅ Service Fee Charged",
        "deposit-charged-body": "Your card was successfully charged the {amt} service fee.",
        "deposit-pending-title": "⚠️ Service Fee Pending — Action Needed",
        "deposit-pending-body": "Please update your payment method to pay the {amt} service fee.",
        "deposit-requested-desc": "A {amt} service fee was applied for your successful reservation.",
        ...
        "success-msg": "Your table for {people} on {dateStr} at {time} is successfully booked!",
        ...
        "alt-proposed-msg": "The restaurant couldn't book {time}, but proposed a new time:",
    ...
    "ja": {
        ...
        "lang-zh-CN": "中国語（簡体）",
        "lang-ko": "韓国語",
        "deposit-title": "お支払い方法",
        "deposit-desc": "クレジットカードが必要です。予約が正常に完了した場合にのみ、5ドルのサービス料が請求されます。",
        ...
        "mode-now": "即座に発信",
        "mode-schedule": "予約発信",
        "label-callMode": "発信タイミング",
        "label-scheduledAt": "予約日時",
        "schedule-hint": "💡 指定した時間にAIがレストランへ電話します。開店時間に合わせて予約するのに便利です！",
        ...
        "label-adults": "大人",
        "label-kids": "子ども",
        "label-kids-age": "12歳未満",
        "alt-offer-desc": "ご希望の時間は満席でした。レストランから新たな時間が提案されました：",
        "deposit-charged-title": "✅ サービス料の引き落とし完了",
        "deposit-charged-body": "カードからサービス料 {amt} が正常に引き落とされました。",
        "deposit-pending-title": "⚠️ サービス料のお支払いが必要です",
        "deposit-pending-body": "{amt} のサービス料について、お支払い方法を更新してください。",
        "deposit-requested-desc": "予約手続きの完了として {amt} のサービス料が適用されました。",
        ...
        "alt-proposed-msg": "{time} のご予約は満席ですが、レストランが別の時間を提案しました：",
    ...
    "zh-TW": {
        ...
        "lang-ko": "韓語",
        "deposit-title": "付款方式",
        "deposit-desc": "需要信用卡資訊。只有在您的訂位成功確認後，我們才會向您收取 5 美元的服務費。",
        "label-cc-name": "持卡人姓名",
        ...
        "mode-schedule": "預約時間",
        "label-callMode": "撥打時機",
        "label-scheduledAt": "預約日期與時間",
        "schedule-hint": "💡 AI 將在您指定的準確時間撥打電話。非常適合在餐廳剛開門時預約！",
        ...
        "label-adults": "成人",
        "label-kids": "兒童",
        "label-kids-age": "12歲以下",
        "alt-offer-desc": "您所需的時段已無座位，餐廳提出了以下備選時間：",
        "deposit-charged-title": "✅ 服務費已成功扣款",
        "deposit-charged-body": "您的信用卡已成功扣除 {amt} 的服務費。",
        "deposit-pending-title": "⚠️ 需要支付服務費",
        "deposit-pending-body": "請更新您的付款方式以支付 {amt} 的服務費。",
        "deposit-requested-desc": "本次成功訂位將收取 {amt} 的服務費。",
        ...
        "agent-standby": "助理待命",
        "success-msg": "您預訂的 {dateStr} {time} {people} 人座位已成功保留！",
        "reservation-failed": "預約失敗",
        "failed-msg": "餐廳在 {time} 已客滿，請嘗試選擇其他日期或時間。",
        "alt-proposed-msg": "餐廳在 {time} 已客滿，但提出了新的時間建議：",
