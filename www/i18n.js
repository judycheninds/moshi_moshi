const translations = {
    "en": {
        ...
        "deposit-charged-title": "✅ Deposit Charged",
        "deposit-charged-body": "Your card was successfully charged {amt}.",
        "deposit-pending-title": "⚠️ Deposit Required — Action Needed",
        "deposit-pending-body": "Please contact the restaurant directly to pay the deposit of {amt}.",
        "deposit-requested-desc": "The restaurant requested a deposit of {amt} to hold your reservation.",
    ...
    "ja": {
        ...
        "deposit-charged-title": "✅ 保証金の引き落とし完了",
        "deposit-charged-body": "カードから {amt} が正常に引き落とされました。",
        "deposit-pending-title": "⚠️ 保証金のお支払いが必要です",
        "deposit-pending-body": "{amt} の保証金について、直接レストランにお支払いください。",
        "deposit-requested-desc": "レストランがご予約を確保するために {amt} の保証金を要求しました。",
    ...
    "zh-TW": {
        ...
        "deposit-charged-title": "✅ 訂金已成功扣款",
        "deposit-charged-body": "您的信用卡已成功扣款 {amt}。",
        "deposit-pending-title": "⚠️ 需要支付訂金",
        "deposit-pending-body": "請直接聯絡餐廳支付 {amt} 的訂金。",
        "deposit-requested-desc": "餐廳要求支付 {amt} 的訂金以保留您的座位。",
